  ...
  return (
    <React.Fragment>
      ...
      <div className="container my-5">
        <h1>Privacy Policy for Samara's estate &amp; builders</h1>

        <p>
          At http://samarasestate.com, accessible from http://samarasestate.com,
          one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by http://samarasestate.com and how we use it.
        </p>
        ...
        <p>
          http://samarasestate.com follows a standard procedure of using log
        ...
        <p>
          ...
          advertising partners of http://samarasestate.com.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on http://samarasestate.com,
        ...
        <p>
          Note that http://samarasestate.com has no access to or control over
        ...
        <p>
          http://samarasestate.com's Privacy Policy does not apply to other
        ...
        <p>
          http://samarasestate.com does not knowingly collect any Personal
