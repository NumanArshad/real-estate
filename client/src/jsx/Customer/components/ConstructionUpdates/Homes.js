        ...
        <div className="container">
          <div className="row my-4">
            <div className="col-md-4 details">
              ...
              {townDetail?.townInformation?.WhyChooseUs?.map((tag) =>
            ...
            <div className="col-md-4 details">
              ...
              {townDetail?.townInformation?.LocationGuide?.map((tag) =>
                <div className="d-flex gap-2">
            ...
            <div className="col-md-4 details">
              ...
              {townDetail?.townInformation?.AffordablePaymentPlan?.map((tag) =>
                <div className="d-flex gap-2">
